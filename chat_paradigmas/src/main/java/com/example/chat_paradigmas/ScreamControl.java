...
public class ScreamControl {
    ...
    public static void iniciar() throws IOException {
        stage.close();
        FXMLLoader loader = new FXMLLoader(ScreamControl.class.getResource("telaInicial.fxml"));
...
//    }
    ...
    public static void telasDeChat() throws IOException {

        stage.close();
        FXMLLoader loader = new FXMLLoader(ScreamControl.class.getResource("telaDoChat.fxml"));
        Parent root = loader.load();
        controler = loader.getController();
        Scene mainScene = new Scene(root, 1000, 664);
        stage.setTitle("Rede social (:");
